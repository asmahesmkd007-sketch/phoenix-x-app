...
class TournamentManager {
    ...
    static startTournament(tournamentId, playersData, tData) {
        ...
        const tState = {
            ...
            max: tData.max_players, timer: tData.timer_type || 3,
    ...
    static initializeMatch(dbMatch, p1, p2, tState) {
        ...
        const match = {
            ...
            chess: new Chess(),
            turn: 'w',
            player1: { userId: p1.user_id, time: (tState.timer || 3) * 60, socketId: [...s1][0], score: 0, connected: p1Online },
            player2: { userId: p2.user_id, time: (tState.timer || 3) * 60, socketId: [...s2][0], score: 0, connected: p2Online },
            winnerId: null,
            fen: 'start',
